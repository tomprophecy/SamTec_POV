...
def yxmc_123(spark: SparkSession, in0: DataFrame) -> DataFrame:
    ...
    out1 = clean_columns(
        out2,
        ["PartNumber", "OpeningUnitCost", "OpeningLaborCost", "OpeningPlannerCode", "ClosingUnitCost",
         "ClosingLaborCost", "ClosingPlannerCode", "PreviousQuarterUnitCost", "PreviousQuarterLaborCost",
         "PreviousQuarterPlannerCode", "OpeningPlatingCost", "ClostingPlatingCost",
         "PreviousQuarterPlatingCost", "OpeningBuyer", "ClosingBuyer", "PreviousQuarterBuyer",
         "OpeningOrderPolicy", "ClosingOrderPolicy", "PreviousQuarterOrderPolicy"]
    )
